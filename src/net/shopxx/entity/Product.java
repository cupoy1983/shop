...
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "bmw_product_sequence")
public class Product extends BaseEntity {
	...
	@Valid
	@ElementCollection
	@CollectionTable(name = "bmw_product_product_image")
	...
	@JoinTable(name = "bmw_product_tag")
	@OrderBy("order asc")
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "bmw_product_specification")
	@OrderBy("order asc")
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "bmw_product_specification_value")
	...
	@CollectionTable(name = "bmw_product_member_price")
	 ...
	 */
	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "bmw_product_parameter_value")
